  ...
  <main className="p-[40px]">
    ...
    <header className="font-primary flex justify-between mb-[40px]">
      <h1 className="text-[28px] font-semibold text-gray-800 flex items-center">
        Tasks
        <span className="bg-blue-500 w-[30px] h-[30px] ml-[10px] text-white font-medium text-[14px] rounded-full flex justify-center items-center">6</span>
      </h1>
        ...
        TaskList.map((task) => (
          <div className="w-full border-[1px] rounded-lg p-[12px] shadow-lg">
            <div className="flex flex-wrap gap-[10px]">
              ...
              <span className={`${statusColor('active')} text-xs rounded-md py-1 px-3`}>
              <FontAwesomeIcon icon={faPlus} />
              </span>
            </div>
            <header className="py-[20px] space-y-[10px]">
