...
export default function TextField({text, icon =''}: TextProps) {
  const [showPassword, setShowPassword] = useState(false);
  const [inputValidity, setInputValidity] = useState(null);
  const inputCss = 'w-full border-[1px] outline-none rounded-lg px-[10px] py-[10px] font-secondary text-[15px]'
